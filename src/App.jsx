    ...
    <>
     <div id= "choosecolour" className="w-screen h-screen duration-200 font-custom flex items-center justify-center text-3xl " 
        style={{backgroundColor: color}}>
            <div className='px-10 flex align-middle font-arial text-3xl '><p>ＣＨＯＯＳＥ</p></div>
            <div className='px-10 flex align-middle font-arial text-3xl '><p>ＹＯＵＲ</p></div>
            <div className='px-10 flex align-middle font-arial text-3xl '><p>ＣＯＬＯＵＲ</p></div>
     </div>
